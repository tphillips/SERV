...
<asp:Content ContentPlaceHolderID="contentPlaceholder" ID="contentPlaceholderContent" runat="server">
	...
	<div id="entry" style="display:none">
		...
		<a type=button id="cmdAdd" class="btn btn-primary btn-lg readOnlyHidden" href="ViewLocation.aspx?new=yes"><i class="icon-plus icon-white"></i> Add a New Location</a>
